    ...
    <>
      ...
      <div className="min-h-screen bg-[#0a0a12] relative">
        ...
        <div className="relative z-10">
          ...
          <footer className="border-t border-purple-500/10 mt-12 py-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    {reseller.footerDescription || "Produtos digitais confiaveis, entrega instantanea"}
                  </p>
                </div>

                <div className="space-y-4">
                  <h4 className="text-purple-400 font-semibold text-sm uppercase tracking-wide">Atendimento</h4>
                  {reseller.supportEmail && (
                    <a 
                      href={`mailto:${reseller.supportEmail}`}
                      className="flex items-center gap-2 text-gray-300 text-sm hover:text-purple-400 transition-colors"
                  ...
                  {reseller.whatsappContact && (
                    <a 
                      href={`https://wa.me/${reseller.whatsappContact}`}
                      target="_blank"
