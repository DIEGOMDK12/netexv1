                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  <div className="md:col-span-1">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      {reseller.footerDescription || "Produtos digitais confiaveis com entrega instantanea. Qualidade e seguranca garantidas."}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {reseller.supportEmail && (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span>{reseller.supportEmail}</span>
                          </div>
                        </a>
                      )}
                      ...
                      {!reseller.supportEmail && !reseller.whatsappContact && (
                        <p className="text-gray-500 text-sm">Configure nas opcoes da loja</p>
                      )}
                    </div>
                  </div>
